/*
 ...
 Source Schema         : ks_tougao

 Target Server Type    : MySQL
 Target Server Version : 50730
 File Encoding         : 65001

 Date: 05/10/2022 09:48:41
*/

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

DROP DATABASE IF EXISTS `ks_tougao`;
CREATE DATABASE `ks_tougao`;
use `ks_tougao`;
...
CREATE TABLE `file_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '文件信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of file_info
-- ----------------------------
INSERT INTO `file_info` VALUES (4, '保时捷911', '2021-06-08 17:08:09', 4, 15, '保时捷911.jpg', 'admin', 1, 1, '单位A', '豪车', '待审核');
INSERT INTO `file_info` VALUES (5, '保时捷SUV', '2021-06-09 17:09:26', 5, 16, '保时捷SUV.mp4', 'admin', 1, 1, '单位B', '豪车', '待审核');
INSERT INTO `file_info` VALUES (6, 'Java基础核心总结', '2021-06-10 16:51:51', 7, 17, 'Java基础核心总结.pdf', 'admin', 1, 1, '单位A', '知识', '待审核');
INSERT INTO `file_info` VALUES (7, '多啦A梦', '2021-06-10 16:56:17', 4, 18, 'src=http___img.alicdn.com_tfscom_TB-2784154082.jpg%3f_TB2NOdcnhXkpuFjy0FiXXbUfFXa_!!2909201442.jpg&refer=http___img.alicdn.jpg', '张天志', 2, 1, '单位A', '卡通', '待审核');
INSERT INTO `file_info` VALUES (8, '测试', '2022-04-15 01:37:08', 4, 19, '1.jpg', 'admin', 1, 1, '单位C', '零食', '待审核');
INSERT INTO `file_info` VALUES (9, '测试文件', '2022-10-05 09:12:49', 4, 20, '经典大床房.jpg', '张天志', 2, 1, '单位A', '酒店', '审核通过');
INSERT INTO `file_info` VALUES (10, '测试文件2', '2022-10-05 09:46:53', 4, 21, '酒店.jpg', '张天志', 2, 1, '单位B', '酒店', '审核通过');
...
CREATE TABLE `nx_system_file_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '文件信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `nx_system_file_info` VALUES (20, '经典大床房.jpg', '经典大床房1664932383112.jpg');
INSERT INTO `nx_system_file_info` VALUES (21, '酒店.jpg', '酒店1664934438422.jpg');
